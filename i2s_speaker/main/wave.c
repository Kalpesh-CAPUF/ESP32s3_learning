...
size_t wave_kalpesh_get_length(WAVE_CONST WaveFile* self)
{
    return self->data_chunk.header.size;
}
size_t wave_kalpesh_get_data_offset(WAVE_CONST WaveFile* self)
{
    return self->data_chunk.offset;
}
